...
help:
	...
	@echo "  make sbom           - Generate SBOM (sbom.json)"
	@echo "  make validate       - Run audit + generate SBOM"
	@echo ""
...
validate: audit sbom
	@echo "✅ Security audit passed, SBOM generated"
...
# Full release: validate, bump, tag, push, GitHub release, npm publish
release-patch: build test validate
...
release-minor: build test validate
...
release-major: build test validate
