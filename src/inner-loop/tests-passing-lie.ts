...
// NOTE: These must be specific success claims, NOT generic commit prefixes.
// "fix(auth): add null check" is NOT a success claim - it's just describing work.
// "fix: auth working now" or "fixed it!" ARE success claims.
